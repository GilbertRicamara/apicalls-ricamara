...
function DataForm() {
    ...
    useEffect(() => { 
        axios.get('https://serverless-api-ricamara.netlify.app/.netlify/functions/api') 
            .then((response) => { 
    ...
    const handleSubmit = (e, id = null) => { 
        ...
        const url = editItem 
            ? `https://serverless-api-ricamara.netlify.app/.netlify/functions/api/${editItem._id}`
            : 'https://serverless-api-ricamara.netlify.app/.netlify/functions/api';
    ...
    const handleDelete = (_id) => { 
        axios 
            .delete( 
                `https://serverless-api-ricamara.netlify.app/.netlify/functions/api/${_id}` 
            ) 
            .then(() => { 
